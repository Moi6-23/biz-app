  ...
  <div class="container col-auto mt-3 ">
      ...
      <div class="row">
          ...
          <form >
            <div class="input-group mb-3 ">
              <input
                ...
                v-model='searchInput'
              />
              <button class="btn btn-primary ps-4 pe-4" @click="dataFilterClick">  Filter  </button>
            </div>
          </form>
        </div>
        <div class='col-12 col-sm-7'>
          ...
          <hr/>
          <div >
              <div class='card mb-3' v-for="dataFilter in dataFilters" :key="dataFilter.id">
                  <div class='row no-gutters'>
                      <div class='col-md-4'>
                          <img
                              class='card-img'
                              :src=dataFilter.imgPath
                          />
                      </div>
                      <div class='col-8'>
                          <div class='card-body'>
